...
public class LoginController {
    ...
    public String carregaPaginaLogin(){
        return "autenticacao/login"; // arquivo HTML localizado em src/main/resources/templates/autenticacao/login.html
    }

    @GetMapping("/alterar-senha")
    public String carregaPaginaAlteracao(){
        return FORMULARIO_ALTERACAO_SENHA; // arquivo HTML localizado em src/main/resources/templates/autenticacao/formulario-alteracao-senha.html
    }

    @PostMapping("/alterar-senha")
    public String alterarSenha(@Valid @ModelAttribute("dados") DadosAlteracaoSenha dados, BindingResult result, Model model, @AuthenticationPrincipal
    Usuario logado) {
        if (result.hasErrors()) {
